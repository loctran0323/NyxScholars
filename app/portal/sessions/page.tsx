...
export default async function SessionsPage() {
 ...
 <h1 className="text-[26px] text-[var(--text-1)]">My Sessions</h1>
 </div>
 <Link
 href="/portal/schedule"
 className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#0c1124] border border-[var(--accent)]/45 text-[var(--text-1)] font-semibold hover:bg-[#141a30] hover:border-[var(--accent)] text-[13px] transition-all"
 >
 ...
 <Link
 href="/portal/schedule"
 className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0c1124] border border-[var(--accent)]/45 text-[var(--text-1)] font-semibold hover:bg-[#141a30] hover:border-[var(--accent)] text-[13px] transition-all"
 >
 <CalendarPlus size={14} />
