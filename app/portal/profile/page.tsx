  ...
  return (
    <div className="max-w-xl space-y-6">
      <div className="mb-7">
        ...
        <h1 className="text-[26px] font-bold text-[var(--text-1)]">Profile Settings</h1>
      ...
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6">
        <h2 className="text-[15px] font-semibold text-[var(--text-1)] mb-5">Personal Information</h2>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              value={email}
              disabled
              className="w-full h-10 px-3.5 rounded-xl bg-[var(--bg-2)]/60 border border-[var(--border)] text-[14px] text-[var(--text-3)] cursor-not-allowed"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              <label className="block text-[13px] font-medium text-[var(--text-2)]">
                Target score <span className="text-[var(--text-3)] font-normal">(optional)</span>
              </label>
              <input
                type="text"
                value={targetScore}
            ...
            <div className="space-y-1.5">
              <label className="block text-[13px] font-medium text-[var(--text-2)]">
                Phone <span className="text-[var(--text-3)] font-normal">(optional)</span>
              </label>
              <input
                type="tel"
                value={phone}
      ...
      {/* Change password */}
      <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl p-6">
        <h2 className="text-[15px] font-semibold text-[var(--text-1)] mb-1 flex items-center gap-2">
          <Key size={15} className="text-[var(--text-3)]" />
          Change Password
        </h2>
        <p className="text-[12px] text-[var(--text-3)] mb-5">Set a new password for your account.</p>
        ...
        <form onSubmit={handleChangePassword} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="block text-[13px] font-medium text-[var(--text-2)]">New password</label>
            <input
              type="password"
              value={newPassword}
          ...
          <button
            ...
            className={cn(
              ...
              passwordSaved
                ...
                : "bg-white/[0.05] border-white/[0.1] text-[var(--text-1)] hover:border-[var(--border-2)] hover:text-[var(--text-1)]",
