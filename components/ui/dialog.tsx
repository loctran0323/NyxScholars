  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-2xl border border-[var(--border)] bg-[var(--surface-elevated)] p-6 shadow-[0_24px_64px_rgba(0,0,0,0.55)]",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-[16px] font-semibold text-[var(--text-1)]", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-[13.5px] text-[var(--text-2)] leading-relaxed", className)}
    {...props}
  />
));
