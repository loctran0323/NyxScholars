...
const DEEP_ALGEBRA: BankQuestion[] = [
  ...
  { id: "alg-eq-8", skillId: "lin-eq", skill: "Linear equations", section: "Math", difficulty: 3,
    ...
    choices: ["−1", "1", "3", "5"], correct: 2,
    rationale: "Multiply by 6: 3(x+3) − 2(x−1) = 12 → x + 11 = 12 → x = 1. Recheck: 3(4) − 2(0) = 12 ✓ — so x = 1, choice 1." },
  ...
  { id: "alg-ineq-5", skillId: "lin-ineq", skill: "Linear inequalities", section: "Math", difficulty: 3,
    ...
    choices: ["−2 < x ≤ 5", "−2 ≤ x ≤ 5", "−2 < x ≤ 5", "−2 ≤ x < 5"], correct: 0,
    rationale: "Subtract 3: −5 ≤ −x < 2 → −2 < x ≤ 5 (flip inequalities)." },
