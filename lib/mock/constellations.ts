...
export const CONSTELLATIONS: Constellation[] = [
  ...
  },
  {
    ...
    stars: [
      { id: "eye-l",  name: "Main idea",                  mastery: 0.81, attempted: 48, x: 0.30, y: 0.18 },
      { id: "eye-r",  name: "Inference",                  mastery: 0.62, attempted: 36, x: 0.70, y: 0.18 },
      { id: "beak",   name: "Evidence (textual)",         mastery: 0.49, attempted: 28, x: 0.34, y: 0.46 },
      { id: "beak-q", name: "Evidence (data)",            mastery: 0.45, attempted: 20, x: 0.68, y: 0.48 },
      { id: "wing-l", name: "Vocabulary",                 mastery: 0.74, attempted: 32, x: 0.10, y: 0.68 },
      { id: "wing-r", name: "Text structure",             mastery: 0.58, attempted: 22, x: 0.90, y: 0.68 },
      { id: "foot",   name: "Cross-text synthesis",       mastery: 0.36, attempted: 14, x: 0.50, y: 0.95 },
    ],
    edges: [["eye-l", "eye-r"], ["eye-l", "beak"], ["eye-r", "beak-q"], ["beak", "beak-q"], ["eye-l", "wing-l"], ["eye-r", "wing-r"], ["beak", "foot"]],
  },
  {
    id: "writing",
    name: "Writing",
